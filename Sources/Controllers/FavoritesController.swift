...
final class FavoritesController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    private lazy var podcastRepository: FavoritePodcastsRepository =
        LocalFavoritePodcastsRepository { [weak self] (insertedIndexPaths, deletedIndexPaths, updatedIndexPaths) in
